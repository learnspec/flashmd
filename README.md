...
**FlashMD** is an open, Markdown-based format for flashcards and spaced repetition.

A `.flash.md` file is valid Markdown — readable by humans, versionable in Git, and consumable by any compatible LearnSpec player. It defines front/back cards designed for review sessions, with LaTeX support from Level 0.
